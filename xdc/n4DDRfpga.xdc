...
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_PWDN }]; #IO_L23N_T3_35 Sch=jc[1]
set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[0] }]; #IO_L19N_T3_VREF_35 Sch=jc[2]
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[2] }]; #IO_L22N_T3_35 Sch=jc[3]
set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[4] }]; #IO_L19P_T3_35 Sch=jc[4]
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_RESET }]; #IO_L6P_T0_35 Sch=jc[7]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[1] }]; #IO_L22P_T3_35 Sch=jc[8]
set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[3] }]; #IO_L21P_T3_DQS_35 Sch=jc[9]
set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[5] }]; #IO_L5P_T0_AD13P_35 Sch=jc[10]

##Pmod Header JD

set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[6] }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_XCLK }]; #IO_L17P_T2_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_HREF }]; #IO_L17N_T2_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVTTL SLEW SLOW PULLUP TRUE} [get_ports { OV7670_SIOD }]; #IO_L20N_T3_35 Sch=jd[4]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_DATA[7] }]; #IO_L15P_T2_DQS_35 Sch=jd[7]
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_PCLK }]; #IO_L20P_T3_35 Sch=jd[8]
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_VSYNC }]; #IO_L15N_T2_DQS_35 Sch=jd[9]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVTTL SLEW SLOW} [get_ports { OV7670_SIOC }]; #IO_L13N_T2_MRCC_35 Sch=jd[10]
